...
namespace Microsoft.Health.Fhir.Core.Features
{
    public static class KnownDataStores
    {
        ...
        public const string Hss = nameof(Hss);
        ...
        public static bool IsHssDataStore(string dataStoreName)
        {
            EnsureArg.IsNotNullOrWhiteSpace(dataStoreName, nameof(dataStoreName));

            return string.Equals(Hss, dataStoreName, StringComparison.OrdinalIgnoreCase);
        }
    }
}
